...
//    private let localXMLFilename = "hsr-early-termination-notices" // ** NAME OF YOUR XML FILE (without .xml) **
//
//    var body: some View {
//        NavigationView {
//            Group {
...
//    // Ensure 'hsr-early-termination-notices.xml' exists in your project and is added to the target's bundle resources.
