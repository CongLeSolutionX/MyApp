...
//                .colorEffect(matrixShader, userInfo: [
//                    // Pass necessary parameters to the shader
//                    // Note: Parameters must match the shader signature IN ORDER
//                    .float(Float(context.date.timeIntervalSinceReferenceDate)), // currentTime
//                    .float2(glyphSize), // glyphSize
//                    .float(minSpeed),   // minSpeed
//                    .float(maxSpeed),   // maxSpeed
//                    .float(tailLength), // tailLength
//                    .float3(baseGreen), // baseGreen color
//                    .float3(highlightColor) // highlightColor
//                ])
