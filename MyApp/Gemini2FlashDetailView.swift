...
//
//struct Gemini2FlashDetailView: View {
//
...
//                        // --- Model Code ---
//                        PropertyRow(iconName: "rectangle.stack", propertyName: "Model code") {
...
//                        PropertyRow(iconName: "doc.text", propertyName: "Supported data types") {
...
//
//                        // --- Token Limits ---
//                        PropertyRow(iconName: "gauge.high", propertyName: "Token limits[*]") {
//                            VStack(alignment: .leading, spacing: 5) {
...
//
//                        // --- Capabilities ---
//                        PropertyRow(iconName: "wrench.and.screwdriver", propertyName: "Capabilities") {
...
//
//                        // --- Versions ---
//                        PropertyRow(iconName: "list.bullet.rectangle", propertyName: "Versions") {
...
//
//                        // --- Latest Update ---
//                        PropertyRow(iconName: "calendar", propertyName: "Latest update") {
//                            Text("February 2025")
//                        }
//                        Divider()
//
//                        // --- Knowledge Cutoff ---
//                         PropertyRow(iconName: "brain.head.profile", propertyName: "Knowledge cutoff") {
//                             Text("August 2024")
//                         }
//
//                    }
