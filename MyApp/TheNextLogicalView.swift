...
//    @State private var showSaveAlert = false // Combined alert state
//    @State private var saveStatusMessage = ""
//    @State private var saveDidFail = false // Track if save failed for alert title
//
...
//
//    var body: some View {
//        // Embed in NavigationView for title and toolbar items
//        NavigationView {
//           VStack(spacing: 20) {
...
//                 else {
//                     VStack {
//                         Image(systemName: "photo.fill.on.rectangle.fill") // More relevant icon
//                             .font(.largeTitle)
...
//             }
//             .onAppear { masterViewModel.prepareDrawingForExport() } // Prepare on appear
//             .onDisappear { masterViewModel.clearExportDrawing() }   // Clean up on disappear
//             // Background hosts the Share Sheet representable safely
//             .background(
//                 ActivityViewRepresentable(
//                     activityItems: [imageToExport ?? UIImage()], // Always provide something (even empty)
//                     isPresented: $isShareSheetPresented,
//                     completion: { activityType, completed, returnedItems, error in
//                           if completed {
//                               masterViewModel.statusMessage = "Shared successfully."
//                           } else if error == nil {
//                               masterViewModel.statusMessage = "Share cancelled."
//                           } else {
//                               masterViewModel.handleAppError(.generic("Sharing failed: \(error!.localizedDescription)"))
//                           }
//                       }
//                 )
//                 .frame(width: 0, height: 0)
//             )
//             .alert(isPresented: $showSaveAlert) { // Single alert for save status
//                  Alert(
...
//              }
//         }
//         .navigationViewStyle(.stack) // Consistent modal presentation
//         .interactiveDismissDisabled(masterViewModel.isPreparingExport) // Prevent dismissal while loading
//     }
//
//    // --- Save Logic ---
...
//                } else {
//                    sel.saveStatusMessage = "Failed to save image."
//                    self?.saveDidFail = true
//                    self?.masterViewModel.handleAppError(.saveFailed(error)) // Use specific error
//                    if let err = error { // Add detail if available
//                        self?.saveStatusMessage += "\n\(err.localizedDescription)"
//                    }
//                }
//                self?.showSaveAlert = true // Show confirmation/error alert
//            }
//        }
//    }
//}
...
//
//    private var isCameraAvailable: Bool { // For potential future use if needed
...
//                    if masterViewModel.isLoading || masterViewModel.isPreparingExport { // Show if any loading active
...
//                     HStack {
//                         Button("Apple Dev Site") { openSafari(with: "https://developer.apple.com/swiftui/") }
//                         Spacer()
//                         Button("Example.com") { openSafari(with: "https://www.example.com") }
//                     }.buttonStyle(.bordered)
...
//                        Slider(value: $drawingStrokeWidth, in: 1...20, step: 1)
//                    }
...
//                    Button("Clear Drawing", role: .destructive) { clearDrawingPad = true }
//                     .buttonStyle(.bordered)
...
//                 }
//            }
//            .sheet(isPresented: $showingExportView) { // Modal sheet for ExportView
//                 ExportView(masterViewModel: masterViewModel)
//            }
//
//            // --- Alert for Errors ---
//           .onChange(of: masterViewModel.currentError) {
//               let error = masterViewModel.currentErrors
...
//}
//
//// MARK: - 4. App Entry Point and Preview
//
////struct ContentView_Previews: PreviewProvider {
////     static var previews: some View {
////         ContentView()
////              // Optionally Inject Preview Data into ViewModel if needed
////              // .environmentObject(MasterViewModel()) // Or pre-populate for testing
////     }
////}
//
///*
//// Uncomment this to make it the main application entry point
//@main
