...
//import Foundation
//
//// MARK: - Playback State Observable (for WebView integration)
//
...
//}
//
//// MARK: - Spotify Embed WebView (UIViewRepresentable with PlaybackState)
//
...
//        // Only load new URI if API and controller ready and URI changed
...
//                            // Update playback state observable
...
//
//            // JS snippet to create controller and wire event listeners
//            let script = """
...
//}
//
//// MARK: - Spotify Embed Card View with Playback State
//
...
//                    }
//                }
//                // Playback status text with accessibility label
...
//}
//
//// MARK: - Track Details View with Mock Playback Control and Actions
//
...
//                    } label: {
//                        Label(isPlaying ? "Pause" : "Play Now",
...
//}
//
//// MARK: - Main Content View with Multiple Cards & Playlist Selection
//
//struct ContentView: View {
//    @State private var selectedUri: String? = nil
//    // PlaybackState to propagate to SpotifyEmbedView if needed
...
//                        .frame(height: 240)
//
//                    // Selection Buttons to change global embed URI
//                    VStack(spacing: 12) {
...
//}
//
//// MARK: - SpotifyEmbedView with PlaybackState Injection
//
