...
extension CGPoint: @retroactive Sequence, @retroactive ExpressibleByIntegerLiteral, @retroactive ExpressibleByFloatLiteral, @retroactive ExpressibleByArrayLiteral {
...
extension CGSize: @retroactive Sequence, @retroactive ExpressibleByIntegerLiteral, @retroactive ExpressibleByFloatLiteral, @retroactive ExpressibleByArrayLiteral {
  public init(integerLiteral value: Int) {
...
extension CGRect: @retroactive Sequence, @retroactive ExpressibleByIntegerLiteral, @retroactive ExpressibleByFloatLiteral, @retroactive ExpressibleByArrayLiteral {
  public init(integerLiteral value: Int) {
