...
//          }
//         .onChange(of: spotifyUri) {
//             print("SpotifyEmbedPlayerView URI Changed to: \(spotifyUri)")
//             // The WebView's updateUIView handles the actual loading change
//         }
//         .onChange(of: playbackState.isPlaying) {
//              print("Playback state changed: \(playbackState.isPlaying ? "Playing" : "Paused")")
//         }
//    }
//
