...
// MARK: - RenderingLinesMTKViewWrapper
// 1. RenderingLinesMTKViewWrapper: A SwiftUI view that hosts the MTKView
struct RenderingLinesMTKViewWrapper: UIViewRepresentable {
    ...
    func makeCoordinator() -> MetalDrawingLogicCoordinator {
        // Modified closure to propagate changes from binding
        MetalDrawingLogicCoordinator(showLines: _showLines)
    }
}

// MARK: - MetalDrawingLogicCoordinator
// 2. Coordinator: Manages Metal drawing logic
class MetalDrawingLogicCoordinator: NSObject {
...
// MARK: - MetalDrawingLogicCoordinator extnesion - MTKViewDelegate
// 3. MTKViewDelegate: Rendering logic
extension MetalDrawingLogicCoordinator: MTKViewDelegate {
...
// MARK: - Rendering3DMushroomMetalView
// 4. Rendering3DMushroomMetalView: Example usage
struct Rendering3DMushroomMetalView: View {
    ...
    var body: some View {
        VStack {
            Toggle("show lines", isOn: $showLines)
                .padding()
            RenderingLinesMTKViewWrapper(showLines: $showLines)
        }
    }
}

// MARK: - Preview
#Preview("Rendering 3D Mushroom on a Metal view") {
