...
//import Foundation
//
//// MARK: - Intense Red Neumorphism Theme Constants & Helpers
//
//struct IntenseRedNeumorphicTheme {
//    // --- Core Neumorphic Structure (Dark/Neutral) ---
...
//    
//    // --- Primary Accent Color (Intense Red) ---
//    // Using the user-provided extended sRGB definition.
//    // On standard displays, this will clamp to red: 1.0.
//    static let accentColor = Color(.sRGB, red: 1.2, green: 0, blue: 0)
//    
//    // --- Error Color (Distinct Red) ---
//    // Slightly less intense than the main accent to avoid confusion
//    static let errorColor = Color(red: 0.9, green: 0.15, blue: 0.15)
//    
...
//                    .fill(IntenseRedNeumorphicTheme.elementBackground)
//                    .shadow(color: IntenseRedNeumorphicTheme.darkShadow,
//                            radius: IntenseRedNeumorphicTheme.shadowRadius,
//                            x: IntenseRedNeumorphicTheme.shadowOffset,
//                            y: IntenseRedNeumorphicTheme.shadowOffset)
//                    .shadow(color: IntenseRedNeumorphicTheme.lightShadow,
//                            radius: IntenseRedNeumorphicTheme.shadowRadius,
//                            x: -IntenseRedNeumorphicTheme.shadowOffset,
//                            y: -IntenseRedNeumorphicTheme.shadowOffset)
//            )
...
//            .background(IntenseRedNeumorphicTheme.elementBackground) // Base color inside
//            .clipShape(RoundedRectangle(cornerRadius: cornerRadius))
//            .overlay( // Simulate the inner shadows on the container
//                RoundedRectangle(cornerRadius: cornerRadius)
//                    .stroke(IntenseRedNeumorphicTheme.background, lineWidth: 4) // Match background
//                    .shadow(color: IntenseRedNeumorphicTheme.darkShadow, radius: IntenseRedNeumorphicTheme.shadowRadius - 1, x: IntenseRedNeumorphicTheme.shadowOffset - 1, y: IntenseRedNeumorphicTheme.shadowOffset - 1)
//                    .shadow(color: IntenseRedNeumorphicTheme.lightShadow, radius: IntenseRedNeumorphicTheme.shadowRadius - 1, x: -(IntenseRedNeumorphicTheme.shadowOffset - 1), y: -(IntenseRedNeumorphicTheme.shadowOffset - 1))
...
//        ZStack {
//            RoundedRectangle(cornerRadius: cornerRadius)
//                 // Fill with element background, not accent color
//                .fill(IntenseRedNeumorphicTheme.elementBackground)
//            
//            if isPressed {
//                // Simulate Inner Shadow: Apply outer shadows to an inset shape
//                RoundedRectangle(cornerRadius: cornerRadius)
//                     // Use element background for stroke, or maybe a slightly darker version
//                    .stroke(IntenseRedNeumorphicTheme.elementBackground, lineWidth: 4)
//                    .shadow(color: IntenseRedNeumorphicTheme.darkShadow, radius: IntenseRedNeumorphicTheme.shadowRadius / 2, x: IntenseRedNeumorphicTheme.shadowOffset / 2, y: IntenseRedNeumorphicTheme.shadowOffset / 2)
//                    .shadow(color: IntenseRedNeumorphicTheme.lightShadow, radius: IntenseRedNeumorphicTheme.shadowRadius / 2, x: -IntenseRedNeumorphicTheme.shadowOffset / 2, y: -IntenseRedNeumorphicTheme.shadowOffset / 2)
//                    .clipShape(RoundedRectangle(cornerRadius: cornerRadius))
//            } else {
//                // Outer Shadow (Extruded)
//                RoundedRectangle(cornerRadius: cornerRadius)
//                    .fill(IntenseRedNeumorphicTheme.elementBackground) // Needed again to draw shadows on
//                    .shadow(color: IntenseRedNeumorphicTheme.darkShadow,
//                            radius: IntenseRedNeumorphicTheme.shadowRadius,
//                            x: IntenseRedNeumorphicTheme.shadowOffset,
//                            y: IntenseRedNeumorphicTheme.shadowOffset)
...
//}
//
//// MARK: - Spotify Embed WebView (Unchanged from previous, theme agnostic)
//
...
//}
//
//// MARK: - SwiftUI Views (Intense Red Neumorphism Themed)
//
//// MARK: Main List View
...
//                IntenseRedNeumorphicTheme.background.ignoresSafeArea()
//                
//                // --- Content Area ---
...
//            .navigationBarTitleDisplayMode(.large) // Adjust as needed
//            .toolbar {
//                // Optional: Can customize toolbar items here
//            }
//            // --- Search Bar ---
...
//            .onChange(of: searchQuery) { if currentError != nil { currentError = nil } } // Clear error on typing
//            .accentColor(IntenseRedNeumorphicTheme.accentColor) // Tint cursor/cancel button with intense red
//            
//        } // End NavigationView
...
//        ScrollView {
//            LazyVStack(spacing: 18) { // Spacing between neumorphic cards
//                // --- Metadata Header ---
...
//        VStack {
//            ProgressView()
//                 // Use intense red accent for loading spinner
//                .progressViewStyle(CircularProgressViewStyle(tint: IntenseRedNeumorphicTheme.accentColor))
//                .scaleEffect(1.5)
//            Text("Loading...")
//                .font(neumorphicFont(size: 14))
//                .foregroundColor(IntenseRedNeumorphicTheme.secondaryText)
//                .padding(.top, 10)
//        }
//    }
//    
...
//                // Subtle border matching element background
//                .overlay(RoundedRectangle(cornerRadius: 12).stroke(IntenseRedNeumorphicTheme.elementBackground.opacity(0.5), lineWidth: 1))
//                
//            // --- Text Details ---
//            VStack(alignment: .leading, spacing: 4) {
//                Text(album.name)
//                    .font(neumorphicFont(size: 15, weight: .semibold))
//                    .foregroundColor(IntenseRedNeumorphicTheme.primaryText)
//                    .lineLimit(2)
//                
...
//                        .background(IntenseRedNeumorphicTheme.background.opacity(0.6), in: Capsule())
//                     
...
//        .modifier(NeumorphicOuterShadow()) // Apply neumorphic effect
//        .frame(height: 110) // Consistent height
//    }
//}
//
//// MARK: Placeholders (Intense Red Theme Applied)
...
//                .font(.system(size: 50))
//                .foregroundColor(IntenseRedNeumorphicTheme.errorColor) // Use distinct error red
//                .padding(25)
//                .background(
//                    Circle()
//                        .fill(IntenseRedNeumorphicTheme.elementBackground)
//                         // Apply shadows to the circle bg
//                         .shadow(color: IntenseRedNeumorphicTheme.darkShadow, radius: 8, x: 5, y: 5)
//                         .shadow(color: IntenseRedNeumorphicTheme.lightShadow, radius: 8, x: -5, y: -5)
//                )
//                .padding(.bottom, 15)
//            
//            // --- Text ---
...
//                    .font(neumorphicFont(size: 13))
//                    .foregroundColor(IntenseRedNeumorphicTheme.errorColor.opacity(0.8))
//                    .multilineTextAlignment(.center)
//                    .padding(.horizontal, 30)
////            }
//        }
...
//    }
//    
//    // --- Helper properties (using themed error color) ---
...
//        } else {
//             let escapedQuery = searchQuery.replacingOccurrences(of: "*", with: "").replacingOccurrences(of: "_", with: "")
...
//        attributedString.foregroundColor = IntenseRedNeumorphicTheme.secondaryText
...
//        .toolbarBackground(IntenseRedNeumorphicTheme.elementBackground, for: .navigationBar)
...
//                         .fill(IntenseRedNeumorphicTheme.elementBackground)
//                         .shadow(color: IntenseRedNeumorphicTheme.darkShadow, radius: 10, x: 6, y: 6)
//                         .shadow(color: IntenseRedNeumorphicTheme.lightShadow, radius: 10, x: -6, y: -6)
//                 )
//                .padding(.horizontal, 40)
//            
//            // --- Text Details ---
...
//                    .foregroundColor(IntenseRedNeumorphicTheme.secondaryText.opacity(0.8))
//            }
//            .padding(.horizontal)
//            
//        }
...
//                             ProgressView().tint(IntenseRedNeumorphicTheme.accentColor) // Red spinner
//                        } else if let error = playbackState.error {
//                            VStack(spacing: 2){
//                                Image(systemName: "exclamationmark.triangle")
//                                    .foregroundColor(IntenseRedNeumorphicTheme.errorColor)
//                                Text(error)
//                                    .font(.caption2) // Smaller error text
//                                    .foregroundColor(IntenseRedNeumorphicTheme.errorColor)
//                                    .lineLimit(1)
//                                    .multilineTextAlignment(.center)
//                            }
...
//                         .fill(IntenseRedNeumorphicTheme.elementBackground)
//                         .shadow(color: IntenseRedNeumorphicTheme.darkShadow, radius: 5, x: 3, y: 3)
//                         .shadow(color: IntenseRedNeumorphicTheme.lightShadow, radius: 5, x: -3, y: -3)
//                 )
//            
...
//                     Text("Error: \(error)")
//                         .font(neumorphicFont(size: 10, weight: .medium))
//                         .foregroundColor(IntenseRedNeumorphicTheme.errorColor) // Error red
//                         .lineLimit(1)
//                         .frame(maxWidth: .infinity, alignment: .leading)
...
//                        .font(neumorphicFont(size: 10, weight: .semibold)) // Slightly bolder status
//                        .foregroundColor(playbackState.isPlaying ? IntenseRedNeumorphicTheme.accentColor : IntenseRedNeumorphicTheme.secondaryText) // Red when playing
//                    
//                    Spacer()
//                    
...
//    
//    var body: some View {
//        VStack(alignment: .leading, spacing: 0) { // Container VStack
//            // --- Section Header ---
//            Text("Tracks")
...
//                .padding(.bottom, 10)
//            
//            // --- Content Container (Neumorphic background) ---
//            Group {
//                if isLoading {
//                    HStack {
//                        Spacer()
...
//                             // Divider().background(IntenseRedNeumorphicTheme.background.opacity(0.5))
//                        }
//                    }
//                 }
//            }
//            .padding(10) // Padding inside the neumorphic shape
//             // --- Neumorphic Background for the Content Area ---
//             .background(
...
//                     .shadow(color: IntenseRedNeumorphicTheme.lightShadow, radius: 5, x: -3, y: -3)
//             )
//             .padding(.horizontal) // Padding for the outer neumorphic container
//            
//        } // End Outer VStack
//    }
//}
...
//                .font(neumorphicFont(size: 12, weight: .medium))
//                 .foregroundColor(isSelected ? IntenseRedNeumorphicTheme.accentColor : IntenseRedNeumorphicTheme.secondaryText) // Red if selected
...
//                     .foregroundColor(isSelected ? IntenseRedNeumorphicTheme.primaryText : IntenseRedNeumorphicTheme.primaryText.opacity(0.9))
...
//                .font(.system(size: 12))
//                .foregroundColor(isSelected ? IntenseRedNeumorphicTheme.accentColor : IntenseRedNeumorphicTheme.secondaryText.opacity(0.6)) // Red if selected
//                .frame(width: 20, alignment: .center)
...
//         // Subtle background highlight using element background
//         .background(isSelected ? IntenseRedNeumorphicTheme.elementBackground.opacity(0.6) : Color.clear)
//         .cornerRadius(8)
//    }
//}
//
...
//                         .fill(IntenseRedNeumorphicTheme.elementBackground)
//                         .modifier(NeumorphicOuterShadow()) // Apply shadow
//                     ProgressView().tint(IntenseRedNeumorphicTheme.accentColor.opacity(0.7)) // Red spinner
//                }
...
//                         .foregroundColor(IntenseRedNeumorphicTheme.secondaryText.opacity(0.5))
//                         .padding(15)
//                 }
...
//}
//
//// MARK: -> Reusable Neumorphic Button (Uses Intense Red Accent)
...
//            }
//            .font(neumorphicFont(size: 15, weight: .semibold))
//             .foregroundColor(IntenseRedNeumorphicTheme.accentColor) // Intense Red for text/icon
//        }
...
//    
//    var body: some View {
//        // Use the themed button directly
//        ThemedNeumorphicButton(text: text, iconName: "arrow.up.forward.app", action: {
...
//            .padding()
//            .background(IntenseRedNeumorphicTheme.background)
...
//        }
//        
//        // Apply Global Navigation Bar Appearance (Intense Red Accent)
//        let appearance = UINavigationBarAppearance()
//        appearance.configureWithOpaqueBackground()
//        appearance.backgroundColor = UIColor(IntenseRedNeumorphicTheme.elementBackground) // Bar background
//        appearance.titleTextAttributes = [.foregroundColor: UIColor(IntenseRedNeumorphicTheme.primaryText)]
//        appearance.largeTitleTextAttributes = [.foregroundColor: UIColor(IntenseRedNeumorphicTheme.primaryText)]
//        
...
//         // Use Intense Red for back button, etc.
//        UINavigationBar.appearance().tintColor = UIColor(IntenseRedNeumorphicTheme.accentColor)
//    }
//    
//    var body: some Scene {
//        WindowGroup {
