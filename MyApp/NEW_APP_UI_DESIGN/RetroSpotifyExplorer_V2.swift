...
//        private var desiredUriBeforeReady: String? // Holds the URI if updateUIView is called before API is ready
//        
...
//                    if abs(self.parent.playbackState.duration - newDuration) > 0.1 ||
...
//}
//
//// MARK: - API Service (uses placeholder token)
//
...
//    var body: some View {
//        ZStack {
//            // Shiny background with gradient and subtle noise/texture
//            LinearGradient(
...
//                            LinearGradient(
//                                colors: [retroNeonPink.opacity(0.5),
//                                         retroNeonCyan.opacity(0.5)],
//                                startPoint: .topLeading,
//                                endPoint: .bottomTrailing),
//                            lineWidth: 1)
//                    )
...
//                .shadow(color: isInitialState ?
//                        retroNeonCyan.opacity(0.5) :
//                            retroNeonPink.opacity(0.5),
//                        radius: 10
//                )
//                .padding(.bottom, 10)
//            
...
//                    LinearGradient(
//                        colors: [retroNeonPink.opacity(0.6),retroNeonCyan.opacity(0.6)],
//                        startPoint: .top,
//                        endPoint: .bottom),
//                    lineWidth: 2)
//                )
...
//                .background(
//                    LinearGradient(colors: [.black.opacity(0.5), .black.opacity(0.2)],
//                                   startPoint: .top,
//                                   endPoint: .bottom
//                                  )
...
//                            LinearGradient(colors: [retroNeonCyan.opacity(0.4), retroNeonPink.opacity(0.4)],
//                                           startPoint: .leading,
//                                           endPoint: .trailing),
//                            lineWidth: 1)
//                        )
//                        .neonGlow(playbackState.isPlaying ? retroNeonLime : retroNeonPink,
//                                  radius: 8) // Dynamic glow based on state
//                )
//                .padding(.horizontal)
//            
...
//                        LinearGradient(colors: [.gray.opacity(0.2), .black.opacity(0.3)],
//                                       startPoint: .top,
//                                       endPoint: .bottom)
//                    )
...
//    // Use mock data
//    static let mockArtist = Artist(id: "artist1",
//                                   external_urls: nil,
//                                   href: "",
//                                   name: "Miles Davis Mock",
//                                   type: "artist", uri: "")
//    static let mockImage = SpotifyImage(height: 300,
//                                        url: "https://i.scdn.co/image/ab67616d00001e027ab89c25093ea3787b1995b4",
//                                        width: 300) // Use 300px image
//    static let mockAlbumItem = AlbumItem(id: "album1",
//                                         album_type: "album",
//                                         total_tracks: 5,
...
//    static let mockImage = SpotifyImage(height: 640,
//                                        url: "https://i.scdn.co/image/ab67616d0000b2737ab89c25093ea3787b1995b4",
//                                        width: 640)
//    static let mockAlbum = AlbumItem(id: "1weenld61qoidwYuZ1GESA",
//                                     album_type: "album",
//                                     total_tracks: 5,
//                                     available_markets: ["US", "GB"],
//                                     external_urls: ExternalUrls(spotify: "https://open.spotify.com/album/1weenld61qoidwYuZ1GESA"),
//                                     href: "",
//                                     images: [mockImage],
//                                     name: "Kind Of Blue (Preview)",
//                                     release_date: "1959-08-17",
